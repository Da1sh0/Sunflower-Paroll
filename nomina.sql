...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2024 a las 13:06:24
...
CREATE TABLE `cargo` (
  ...
  `descripcionC` varchar(10) NOT NULL
...
INSERT INTO `ciudad` (`cod_ciudad`, `nombrec`, `cod_departamento`) VALUES
('1', 'Abriaquí', '5'),
('10', 'Aguadas', '17'),
('100', 'Betania', '5'),
('1000', 'Tona', '68'),
...
INSERT INTO `departamento` (`cod_departamento`, `nombredepartamento`) VALUES
('11', 'BOGOTÁ, D.C.'),
('13', 'BOLÍVAR'),
('15', 'BOYACÁ'),
('17', 'CALDAS'),
...
('100333232', 'johan', 'pinzon', 'viudo', 'CE', 'helmut@gamial', '3125252', 'masculino', '2024-03-13', '2024-03-04', '121321231'),
('103154', 'Helmut', 'Romero', 'soltero', 'CC', 'helmut@gmail.com', '32154564', 'no_indica', '2024-03-06', '2024-03-12', '121321231');
...
('121321231', 'Sena', '312122222', 'asdfasda@fg');
...
INSERT INTO `familiares` (`cod_familiar`, `parentezco`, `documetof`, `fechanacimientof`, `nombref1`, `apellidof1`, `numeroidentificacione`) VALUES
('5494', 'amante', '123', '2024-03-27', 'patricia', 'romprehoragres', '103154'),
('845615', 'Hoija', '10022222', '2024-03-05', 'Vanessa', 'Garcia', '100333232'),
('9565', 'dfgdfg', 'dfgdfg', '2024-02-26', 'dfgdsfgdf', 'ertertre', '103154');
...
CREATE TABLE `nivel_riesgo` (
  `id_nivelr` varchar(2) NOT NULL,
  `descripcionr` varchar(20) DEFAULT NULL,
  `porcentajenr` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `nivel_riesgo` (`id_nivelr`, `descripcionr`, `porcentajenr`) VALUES
('1', 'Riesgo I', 0.522),
('2', 'Riesgo II', 1.044),
('3', 'Riesgo III', 2.436),
('4', 'Riesgo IV', 4.35),
...
CREATE TABLE `tipo_contrato` (
  ...
  `nombreContrato` varchar(10) NOT NULL,
...
--
ALTER TABLE `tipo_contrato`
  MODIFY `idTipo_contrato` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `empleado`
  ADD CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`nit`) REFERENCES `entidad` (`nit`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_entidad_empleado` FOREIGN KEY (`nit`) REFERENCES `entidad` (`nit`) ON DELETE CASCADE;

--
-- Filtros para la tabla `familiares`
--
ALTER TABLE `familiares`
  ADD CONSTRAINT `familiares_ibfk_1` FOREIGN KEY (`numeroidentificacione`) REFERENCES `empleado` (`numeroidentificacione`) ON DELETE CASCADE;
COMMIT;
